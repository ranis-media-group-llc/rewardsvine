    ...
    <head>
        ...
        <?php 
		   ...
		   $controller = $this->router->fetch_directory() . '/' . $this->router->fetch_class();
            $this->load->view('layout/admin/includes/head.php');	// This will load the frontend wide head file which contains required javascripts.
        ...
        <div id="wrapper">
            <?php 
                ...
                if (file_exists( FCPATH . 'application/views/' . $method . '/page_header.php')) {
                    ...
                    $this->load->view('layout/admin/includes/page_header.php');
                }
            ?>        
            <div <?php echo $_SERVER['REQUEST_URI']!='/auth/login'? 'id="page-wrapper"':''?> >
                ...
                if (file_exists( FCPATH . 'application/views/' . $method . '/page_footer.php')) {
                    ...
                    $this->load->view('layout/admin/includes/page_footer.php');
                }
            ?>
                </div>
            </div>
            ...
            <?php     
                ...
                $this->load->view('layout/admin/includes/foot.php'); // This will load the frontend wide foot file which contains required javascripts.
