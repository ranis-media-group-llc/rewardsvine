            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">Admins</h1>
                    </div>

                    <div class="row">
                        <div class="col-xl-12">
                            <div class="table-responsive">
                                <a href="<?= base_url('superadmin/admin/add') ?>" style="right: 0;float: right;"  type="button" class="btn btn-secondary btn-xs text-uppercase btn_add pull-right">
                                    <i class="icon icon-addnew icon-fw icon-lg"></i> Add Admin
                                </a>
                                <br><br>
                                ...
                                <tbody>
                                    <?php foreach ($admins as $user) :  ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('superadmin/admin/history/'.$user->id) ?>" data-toggle="tooltip" title="Redeem History Logs" type="button" class="btn btn-success btn-xs text-uppercase ">
                                                    <i class="icon icon-list icon-fw icon-sm"></i>
                                                </a>
                                                <a href="<?= base_url('superadmin/admin/settings/'.$user->id) ?>" data-toggle="tooltip" title="User Settings" type="button" class="btn btn-success btn-xs text-uppercase ">
