...
function changeTheme($theme, $style, $themeStylesheet, $init) {
    ...
    if ($theme === 'light') {
        $logo.attr('src', $mediaUrl + 'https://via.placeholder.com/334x119');
        $body.find('.dt-login__content-inner .dt-brand__logo-img').attr('src', $mediaUrl + 'https://via.placeholder.com/334x119');
